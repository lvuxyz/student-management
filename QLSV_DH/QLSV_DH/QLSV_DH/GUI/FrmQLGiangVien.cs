                ...
                try
                {
                    using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
                    {
                        ...
                        while (rdr.Read())
                        {
                            ...
                            date_NgaySinh.Text = rdr["NgaySinh"].ToString();
                    ...
                    if (a.checkMGV(txtMGV.Text) == true)
                    {
                        if (a.checkCMDN(txtCMND.Text) == true)
                        {
                            if (imgLoc == "")
                            {
                                try
                                {
                                    a.AddGiangVienKoAnhHS(txtMGV.Text, txtHoten.Text, cbboxGioitinh.Text, DateTime.Parse(date_NgaySinh.Text.ToString()), txtSDT.Text, txtCMND.Text, txtEmail.Text, txtChuyenMon.Text, b.Makhoa(cbboxKhoa.Text));
                                ...
                                {
                                    MessageBox.Show("Không thể thêm giảng viên mới.");
                                }
                            }
                            else
                            {
                                try
                                {
                                    ...
                                    a.AddGiangVienAnhHS(txtMGV.Text, img, txtHoten.Text, cbboxGioitinh.Text, DateTime.Parse(date_NgaySinh.Text.ToString()), txtSDT.Text, txtCMND.Text, txtEmail.Text, txtChuyenMon.Text, b.Makhoa(cbboxKhoa.Text));
                                    MessageBox.Show("Thêm Thành Công");
                                    imgLoc = "";
                                    picsGV.ImageLocation = null;
                                    picsGV.Image = null;
                ...
                if (txtMGV.Text != "")
                {
                    if (a.checkCMDNsuaGV(txtCMND.Text, txtMGV.Text) == true)
                    {
                        if (imgLoc == "")
                        {
                            ...
                            a.updateGiangVienKoANHHS(txtMGV.Text, txtHoten.Text, cbboxGioitinh.Text, dateTime, txtSDT.Text, txtCMND.Text, txtEmail.Text, txtChuyenMon.Text, b.Makhoa(cbboxKhoa.Text));
                            imgLoc = "";
                            picsGV.ImageLocation = null;
                            picsGV.Image = null;
                            btnchonhinh.Enabled = false;
                        ...
                        else
                        {
                            ...
                            img = br.ReadBytes((int)fs.Length);
                            a.updateGiangVienANHHS(txtMGV.Text, img, txtHoten.Text, cbboxGioitinh.Text, DateTime.Parse(date_NgaySinh.Text.ToString()), txtSDT.Text, txtCMND.Text, txtEmail.Text, txtChuyenMon.Text, b.Makhoa(cbboxKhoa.Text));
                            imgLoc = "";
                            picsGV.ImageLocation = null;
                            picsGV.Image = null;
                            btnchonhinh.Enabled = false;
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (click == true)
            {
                ...
                else
                {
                    ...
                    date_NgaySinh.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();
