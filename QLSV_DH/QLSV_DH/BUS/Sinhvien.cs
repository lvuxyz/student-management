...
namespace QLSV_DH
{
    class Sinhvien
    {
        ...
        */
        ...
        public void updateNoChangeImage(int msv, String hoten, DateTime ngaysinh, String gioitinh, String dantoc, String sdt, String cmnd, String email, String hedaotao, String hotenbo, String nghebo, String hotenme, String ngheme, int maxa, int malop, String tinhtrang, String namnhaphoc)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                con.Open();
