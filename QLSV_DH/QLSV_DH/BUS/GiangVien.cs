...
namespace QLSV_DH
{
    class GiangVien
    {
        ...
        public void AddGiangVienAnhHS(String MGV, byte[] img, String HoTen, String GioiTinh, DateTime NgaySinh, String SDT, String CMND, String Email, String ChuyenMon, int Khoa)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                con.Open();
        ...
        public void AddGiangVienKoAnhHS(String MGV, String HoTen, String GioiTinh, DateTime NgaySinh, String SDT, String CMND, String Email, String ChuyenMon, int Khoa)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                con.Open();
        ...
        public void updateGiangVienANHHS(String MGV, byte[] img, String HoTen, String GioiTinh, DateTime NgaySinh, String SDT, String CMND, String Email, String ChuyenMon, int Khoa)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                con.Open();
        ...
        public void updateGiangVienKoANHHS(String MGV, String HoTen, String GioiTinh, DateTime NgaySinh, String SDT, String CMND, String Email, String ChuyenMon, int Khoa)
        {
